...
an account. You are responsible for keeping your login secure and for the activity
under your account. Use the app only for lawful purposes and in line with these
Terms and the rules of the app store you downloaded it from.

## Your content

You own the data you put into the app — your baby profiles, logged activity,
schedules, and other entries. You grant us only the limited permission needed to
store, process, and sync that data so the app can function, including syncing it to
caregivers you invite. We don't claim ownership of your content and we don't use it
...
The app lets you invite others to share access to a baby's log. You are responsible
for who you invite and for the information you choose to share with them. Anyone you
invite to a baby can view and add to that baby's activity log until you remove them.
...
We work to keep the app available and reliable, but we provide it "as is" and can't
guarantee it will always be uninterrupted or error-free. We may add, change, or
remove features over time. We may also update these Terms; if we make material
changes we'll update the date above and, where appropriate, notify you in the app.
...
You can stop using the app and delete your account at any time. We may suspend or
